...
\section{Soal Medium}
    \begin{itemize}
        ...
        \\Query : 
        \lstinputlisting[label={listing9},caption={Medium - 1}, language={sql}]{"../Medium-1.sql"}
        Penjelasan :
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing10},caption={Medium - 2}, language={sql}]{"../Medium-2.sql"}
        \begin{itemize}
            \item Baris 1 : Mengambil data first\_name dari tabel patients
        ...
        \\Query :
        \lstinputlisting[label={listing11},caption={Medium - 3}, language={sql}]{"../Medium-3.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing12},caption={Medium - 4}, language={sql}]{"../Medium-4.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing13},caption={Medium - 5}, language={sql}]{"../Medium-5.sql"}
        \begin{itemize}
            \item Baris 1 : Mengambil data patient\_id, first\_name, dan last\_name dari tabel patients
        ...
        \\Query :
        \lstinputlisting[label={listing14},caption={Medium - 6}, language={sql}]{"../Medium-6.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing15},caption={Medium - 7}, language={sql}]{"../Medium-7.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing16},caption={Medium - 8}, language={sql}]{"../Medium-8.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing17},caption={Medium - 9}, language={sql}]{"../Medium-9.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing18},caption={Medium - 10}, language={sql}]{"../Medium-10.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing19},caption={Medium - 11}, language={sql}]{"../Medium-11.sql"}
        \begin{itemize}
...
\section{Soal Hard}
    \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing20},caption={Hard - 1}, language={sql}]{"../Hard-1.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing21},caption={Hard - 2}, language={sql}]{"../Hard-2.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing22},caption={Hard - 3}, language={sql}]{"../Hard-3.sql"}
        \begin{itemize}
        ...
        \pagebreak
        \\Query :
        \lstinputlisting[label={listing23},caption={Hard - 4}, language={sql}]{"../Hard-4.sql"}
        \begin{itemize}
        ...
        \\Query :
        \lstinputlisting[label={listing24},caption={Hard - 5}, language={sql}]{"../Hard-5.sql"}
        \begin{itemize}
